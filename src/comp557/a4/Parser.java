...
public class Parser {
	...
	public static Scene createScene(Node dataNode) {
        ...
        for ( int i = 0; i < nodeList.getLength(); i++ ) {
            ...
            if ( nodeName.equalsIgnoreCase( "material" ) ) {                
        		...
        		Quadrics quadric = Parser.createQuadric(n);
	...
	public static Material createMaterial(Node dataNode) {
		...
		if( refAttr  != null ) {
	    	...
	    	Node reflectionAttr = dataNode.getAttributes().getNamedItem("reflection");
	...
	public static Quadrics createQuadric(Node dataNode) {
		
		Quadrics quadric=new Quadrics();
